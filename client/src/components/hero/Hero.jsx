...
export default function Hero() {
  ...
  return (
    <div className="rockitcoins__hero section__padding">
      <div className="rockitcoins__hero__content">
        ...
        <p>
          Explore the Blockchain. Send and receive cryptocurrencies easily and
          securely on RockItCoin
        </p>

        <div className="rockitcoins__hero__content__button">
          {!currentAccount && (
      ...
      <div className="rockitcoins__hero__content__action">
        <div className="rockitcoins__hero__content__action__card eth-card">
          <div className="rockitcoins__hero__content__action__card__content">
            <div className="rockitcoins__hero__content__action__card__content__icons">
              <div className="rockitcoins__hero__content__action__card__content__ethereum">
        ...
        <div className="rockitcoins__hero__content__action__form form">
          <Input
